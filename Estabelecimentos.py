...
competencia = 202210 #É Necessário Digitar a competência que deseja buscar.
data = []
...
def Connect():
    ...
    try:      
        ...
        sql = '''CREATE TABLE IF NOT EXISTS cnesEstabelecimentosAux(
        COMPETENCIA TEXT,
        CO_UNIDADE TEXT,
        CO_CNES TEXT,
        ...
        for i in tqdm(data.index):
            ...
            sql = ''' INSERT INTO cnesEstabelecimentosAux 
